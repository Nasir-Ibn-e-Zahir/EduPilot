...
export default function UserPDFList() {
  ...
  const handleDownloadAll = () => {
    const zipUrl = "/api/download-all"; // API route (we'll define this next)
  ...
  return (
    <div className="flex flex-row w-screen">
      <Sidebar  className="hover:hidden">
        <SidebarContent>
          <SidebarGroup>
      ...
      <div className="w-full flex-1">
        {showNavbar?  <nav  
        className="w-full h-[50px] bg-gray-700 text-white p-2 flex flex-row justify-between "
        >
            {SelectedId}
